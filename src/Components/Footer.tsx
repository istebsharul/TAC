  ...
  return (
    <>
      <div className="w-full text-center">
        <img src="https://res.cloudinary.com/drszvaldf/image/upload/v1719069730/TAC/u1jwlgxy4jxovyw9y7ts.png" alt="Footer Pattern" className="w-full" />
      </div>
      ...
      <footer className="mx-auto py-4 px-5 lg:px-40 w-full h-auto bg-[#e4e2dd] text-black flex flex-col justify-between text-center">
        <div className="flex flex-col lg:flex-row justify-around mx-2 my-6">
          <div className="w-full lg:w-1/5 mb-4 lg:mb-0">
            <img src="https://res.cloudinary.com/drszvaldf/image/upload/v1719048815/TAC/kqi5tyefif6jzik9i33y.png" alt="Logo" className="mx-auto lg:mx-0 w-32 lg:w-full" />
