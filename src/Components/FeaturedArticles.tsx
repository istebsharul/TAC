        ...
        <div className='w-full flex justify-center items-center bg-[#1A1A1A] py-20'>
            <div className="md:w-3/5 bg-[#1A1A1A] text-white p-10">
                <div className="text-center">
                    <h2 className="w-full flex md:flex-row justify-start items-center text-xl font-bold relative inline-block">
                        Featured Articles
                        ...
                        <svg className='block md:hidden absolute bottom-[5%] right-[8%]' width="108" height="18" viewBox="0 0 108 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className=" flex md:flex-row flex-col justify-between md:space-x-10 md:space-y-0 space-y-10 mt-10">
                    <div className="w-full md:max-w-md max-w-sm">
                        ...
                        <h3 className="md:text-4xl text-[1.5rem] font-medium mb-2 relative">When is the right time to rebrand?
                    ...
                    <div className="w-full md:max-w-md max-w-sm">
                        ...
                        <h3 className="md:text-4xl text-[1.3rem] font-medium mb-2 relative">Difference between Advertising and Marketing?
                            <a href="/services/digitalmarketing">
                                <svg className='absolute md:bottom-[5%] bottom-[-55%] right-[18%]' width="108" height="18" viewBox="0 0 108 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M107.061 13.0607C107.646 12.4749 107.646 11.5251 107.061 10.9393L97.5147 1.3934C96.9289 0.807611 95.9792 0.807611 95.3934 1.3934C94.8076 1.97919 94.8076 2.92893 95.3934 3.51472L103.879 12L95.3934 20.4853C94.8076 21.0711 94.8076 22.0208 95.3934 22.6066C95.9792 23.1924 96.9289 23.1924 97.5147 22.6066L107.061 13.0607ZM0 13.5H106V10.5H0V13.5Z" fill="#9747FF" />
                                </svg>
                            </a>
                        </h3>
