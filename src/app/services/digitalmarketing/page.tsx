        ...
        <>
            <div className="min-h-screen bg-[#1A1A1A] text-white relative overflow-hidden">
                <header className="relative flex flex-col items-center justify-center text-center py-20">
                    ...
                    <h1 className="w-3/5 text-7xl font-medium m-6 px-10 relative leading-tight z-10">Transforming Vision into Digital Brilliance, One Click at a Time.</h1>
                ...
                <div className='flex justify-center items-center'><WobbleCardDemo/></div>
